...
export interface BuilderComponentProps {
   ...
   * @see {@link https://github.com/khulnasoft/articulate/tree/master/packages/react#passing-data-and-functions-down}
   *
   * @example
   * ```
   * <BuilderComponent
   ...
   * ## Examples
   *
   * @see {@link https://github.com/khulnasoft/articulate/blob/0f0bc1ca835335f99fc21efb20ff3c4836bc9f41/examples/next-js-builder-site/src/functions/render-link.tsx#L6}
   */
   ...
   * https://github.com/khulnasoft/articulate/tree/master/packages/react#passing-content-manually}
   */
  content?: Content;
  /**
   * @package
