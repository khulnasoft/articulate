...
export const frameworkTabs: Record<Tab, TabInfo> = {
  ...
  react: {
    ...
    language: 'javascript',
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/packages/react',
  },
  next: {
    name: 'Next',
    image:
    ...
    language: 'javascript',
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/examples/next-js',
  },
  gatsby: {
    name: 'Gatsby',
    image:
    ...
    language: 'javascript',
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/packages/gatsby',
  },
  angular: {
    name: 'Angular',
    image:
    ...
    language: 'javascript',
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/examples/angular',
  },
  vue: {
    name: 'Vue',
    image:
    ...
    language: 'html',
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/packages/vue',
  },
  nuxt: {
    name: 'Nuxt',
    image:
  ...
  javascript: {
    ...
    documentationUrl:
      'https://github.com/khulnasoft/articulate/tree/master/packages/core',
  },
};
